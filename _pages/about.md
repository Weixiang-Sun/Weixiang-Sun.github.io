...
- [arxiv 2024](https://img.shields.io/badge/arxiv-2024-red) [[arxiv 2024](https://img.shields.io/badge/arxiv-2024-red)] (https://arxiv.org/abs/2410.23426), Yue Huang, Zhengqing Yuan, Yujun Zhou, Kehan Guo, Xiangqi Wang, Haomin Zhuang, **Weixiang Sun**, Lichao Sun, Jindong Wang, Yanfang Ye, Xiangliang Zhang
...
- ![arxiv 2024](https://img.shields.io/badge/arxiv-2024-red) [Mora: Enabling generalist video generation via a multi-agent framework](https://arxiv.org/abs/2403.13248), Zhengqing Yuan<sup>†</sup>, Yixin Liu<sup>†</sup>, Yihan Cao<sup>†</sup>, **Weixiang Sun**<sup>†</sup>, Haolong Jia, Ruoxi Chen, Zhaoxu Li, Bin Lin, Li Yuan, Lifang He, Chi Wang, Yanfang Ye, Lichao Sun
